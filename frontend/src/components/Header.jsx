...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        > 
            Turn text into <span className="text-blue-600">image</span> , in seconds. </motion.h1>
        ...
        >
            {Array(6).fill("").map((item , index) => (
                <motion.img className="rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10 " src={index%2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt="sample image 1" key={index} width={70}
